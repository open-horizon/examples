...
mqtt_host = os.environ['MQTT_HOST'] #"ibm.mqtt"
mqtt_port = os.environ['MQTT_PORT'] #1883
mqtt_receive_topic = os.environ['MQTT_HWD_WST'] #"mqtt_hwd_wst"
mqtt_send_topic = os.environ['MQTT_WST_EVST'] #"mqtt_wst_evst"

remove_stopword = False
remove_stopword_string = os.environ['REMOVE_SW']
if remove_stopword_string.lower() == "true":
    remove_stopword = True
stopword_removal_host = os.environ['SW_HOST'] #ibm.stopwordremoval
...
def call_speech_to_text():
    try:
        ...
        for l in iter(p.stdout.readline, ''):
            ...
            print("*** This is the result ***: %s" %results, flush=True)
