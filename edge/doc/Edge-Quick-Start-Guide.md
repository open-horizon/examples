...
If you want to develop your own Horizon service, see the [Edge Developer Quick Start Guide](https://github.com/open-horizon/examples/wiki/Edge-Developer-Quickstart-Guide).
...
* If an agreement is not formed, or if the containers are not started, see [Why aren't the expected docker containers running on my edge node?](https://github.com/open-horizon/examples/wiki/Troubleshooting#why-arent-the-expected-docker-containers-running-on-my-edge-node) to troubleshoot.
...
Take a look at the [Edge Troubleshooting Guide](https://github.com/open-horizon/examples/wiki/Troubleshooting).
