# Process for the Horizon Development Team to Make Updates to the Horizon Model Management Service
...
- Perform the steps in the [README.md Preconditions](README.md#preconditions) section, **except**:
    ...
    - Do **not** copy the mms directory (use the git files in this directory instead)
